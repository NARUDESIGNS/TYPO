...
const textCopy = [
        'Relocation', 'Emergencies', 'Interrogation', 'Delusional', 'Inadequate', 'Propellant', 'Underestimated', 'The republic of Nigeria', 'All men must die', 'Say the word and I will be there', 'There are many ways to do it', 'Thank you for playing this game', 'My name is Paul, I made this game', 'Woodwork',
        'Reconciliation', 'Bias', 'Pagination', 'Detectives', 'Abandoned', 'Mountain view', 'A bucket of water', 'A pinch of salt', 'I admire a good chef', 'Send me a link', 'Javascript is amazing!', 'There are people with good hearts', 'Keep typing', 'Do not type me', 'I need a macbook please', 'Generous',
        'Reach for your soul', 'Search the drawers now', 'If you love it, take it', 'Take what belongs to you', 'Say hi for me', 'Flowers are beautiful', 'What is your high score?', 'Jason Derulo', 'I do not believe in rumours', 'Cristiano Ronaldo', 'Sam Smith', 'Naru Designs', 'You made it this far',
        'Reach for the skies', 'Now is the time', 'Objections are valid', 'I piled up a large number of texts', 'Brilliant', 'Have confidence in yourself', 'Nike shoes are cool', 'Leo Messi', 'Neymar is damn good', 'I love learning', 'Sometimes I get scared', 'I trust in God for the future', 'Sublime text editor',
        'Naru is working to reach his goals', 'Rest in peace Kobe Bryant', 'If you are here, smile', 'Do not say things like that', 'I will, watch me', 'It is over', 'Just plead instead', 'Richard Templar', 'Michael Williams', 'Mercedes Benz', 'The duration is 50seconds', 'I keep getting errors', 'Followers',
        'I prefer shorter girls', 'I like to wrap them in my arms', 'God save us all from COVID19', 'I am the best person I know', 'I feel good today', 'I hard coded these texts, sorry', 'Who is you favourite soccer player', 'Do you love the Kardashians?', 'I dance when I get high', 'Speed', 'Gratitude',
        'NOT everyone believes in your abilities',  'Nothing will happen', 'Nothing', 'If you do not see me by 5...', 'How fast can you type?', 'Make time for me', 'Spend time with those you love', 'If you are bored, play this game', 'Mama thought me everything', 'I value you so much', 'Foolishness', 'Honest reply',
        'I am probably not coming today', 'Make 3 wishes now',  'Use your magic wand ', 'It would come to pass', 'Long texts sucks, I know', 'Just believe', 'Nobody does it better than me', 'God bless me, say it', 'Jesus died and is risen again', 'Do you like typing?', 'This is the end', 'RACECAR is a palindrome',
        'If 10 plus 10 is 20, what is 11 plus 11?', 'Do not run away from it', 'It is who you are!', 'I just want to know', 'Do you like me? never mind', 'I took time to make this', 'I hope it is worth it though', '250 people suffered from it', 'They are all really fine now', 'I lied', 'Big bold and beautiful',
        'A girl is no one', 'I am the three eyed raven', 'I prefer iphone to other mobile devices', 'Do not ask me why', 'A lannister always pays his debt', 'Things we do for love', 'Tell him to come bend the knee', 'I would spare everyone of them', 'Kings Landing', 'High garden', 'Tell her everything',
        'All hail the mother of Dragons', 'I give you my word, I am true to my word as always', 'Many have tried', 'None has defeated them in an open field', 'That which is dead may never die', 'A wise man once said...', 'Winter is coming', 'Tokyo and Nairobi are my favourites', 'How about you?', 'Sponsors',
        ...
        'Grenade', 'Supplies', 'Stitches', 'Producer', 'Blurry', 'Logical', 'Humble', 'Village', 'Unfold', 'Vibrant', 'Clearance', 'Govern', 'Nonsense', 'Studious', 'Department', 'Flowers', 'Squares', 'Bitter', 'Activate', 'Squeeze', 'Separate', 'Operation', 'Alignment', 'Forgiven', 'Creative', 'Uphold', 'Decline', 
    ];
